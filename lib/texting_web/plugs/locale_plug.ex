defmodule TextingWeb.Plugs.Locale do
  import Plug.Conn

  @locales Gettext.known_locales(TextingWeb.Gettext)
  def init(_opts), do: nil

  def call(conn, _opts) do
    case  locale_from_params(conn) || locale_from_header(conn) do
      nil -> conn
      locale ->
        IO.puts "++++++++++++ Locale +++++++++++++"
        IO.inspect locale
        IO.puts "++++++++++++ Locale +++++++++++++"
        Gettext.put_locale(TextingWeb.Gettext, locale)
