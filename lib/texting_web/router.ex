defmodule TextingWeb.Router do
  ...
  pipeline :casestudy do
    plug(TextingWeb.Plugs.CaseStudyLayout)
  end
  ...
  # Case study
  scope "/case-study", TextingWeb.CaseStudy do
    pipe_through([:browser, :casestudy])

    get("/churches", ChurchController, :index)
  end
